...
import pacman.infra.ShortestPathFinder;
...
public class Ghost extends PacmanActor {
    ...
    public void init() {
        ...
        for (int i=0; i<8; i++) {
            ghostFrameNames[i] = "/images/ghost_" + type + "_" + i + ".png";
        }
        for (int i=0; i<4; i++) {
            ghostFrameNames[8 + i] = "/images/ghost_vulnerable_" + i + ".png";
        }
        for (int i=0; i<4; i++) {
            ghostFrameNames[12 + i] = "/images/ghost_died_" + i + ".png";
        }
